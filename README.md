...
| **Judge login** | `test@gmail.com` / `Utkarsh.1905` — a real seeded account with a genuine, already-backed-up photo library, not a mocked demo state (see release to download apk) |
